...
class Ui_CSVgenerator(object):
    def setupUi(self, CSVgenerator):
        ...
        self.ifcGrid.addWidget(self.vmg_order, 6, 1, 1, 2)
        ...
        self.ifcGrid.addWidget(self.prio_button, 2, 2, 1, 1)
        ...
        self.ifcGrid.addWidget(self.vh_label, 4, 0, 1, 1)
        ...
        self.ifcGrid.addWidget(self.nesting_path, 2, 1, 1, 1)
        ...
        self.ifcGrid.addWidget(self.bb_label_2, 3, 0, 1, 1)
        ...
        self.ifcGrid.addWidget(self.bb_path, 3, 1, 1, 1)
        ...
        self.ifcGrid.addWidget(self.bb_button, 3, 2, 1, 1)
    ...
    def retranslateUi(self, CSVgenerator):
        ...
        self.ifc_box.setTitle(_translate("CSVgenerator", "IFC -> CSV"))
